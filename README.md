...
### Roadmap to the beta testing:

- ran it locally first to check
- deployed the databases on [Supabase](supabase.com)
- copied the database structure there
- fixed minor errors
- added same library entries to the database
- connected the website to supabase
- tested database by saving and deleting a real post 
- fixed some more errors in code
